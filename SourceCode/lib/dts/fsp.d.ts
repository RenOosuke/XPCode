declare namespace fsp {
    ...
    type WriteVResult = fs.WriteVResult
    type ReadVResult = fs.ReadVResult
    type PathLike = fs.PathLike
    type RmDirAsyncOptions = fs.RmDirAsyncOptions;
    type MakeDirectoryOptions = fs.MakeDirectoryOptions
    type Dirent = fs.Dirent
    type OpenDirOptions = fs.OpenDirOptions
    type Dir = fs.Dir
    type BaseEncodingOptions = fs.BaseEncodingOptions;
    type BufferEncodingOption = fs.BufferEncodingOption
    type OpenMode = fs.OpenMode
    type Mode = fs.Mode
