...
declare namespace exceljs {
    ...
    type TimePeriodTypes = 'lastWeek' | 'thisWeek' | 'nextWeek' | 'yesterday' | 'today' | 'tomorrow' | 'last7Days' | 'lastMonth'
        | 'thisMonth' | 'nextMonth';
    
    type IconSetTypes = '5Arrows' | '5ArrowsGray' | '5Boxes' | '5Quarters' | '5Rating' | '4Arrows' | '4ArrowsGray'
    ...
    type ConditionalFormattingRule = ExpressionRuleType | CellIsRuleType | Top10RuleType | AboveAverageRuleType | ColorScaleRuleType | IconSetRuleType
        | ContainsTextRuleType | TimePeriodRuleType | DataBarRuleType;
    
    
    type RowValues = CellValue[] | { [key: string]: CellValue } | undefined | null; 
