 ...
 * @since v12.12.0
 */
interface Dir extends AsyncIterable<Dirent> {
  /**
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
function mkdtempSync(prefix: string, options?: EncodingOption): string | Buffer;
/**
...
interface NodeJSEventEmitter<T extends EventMap<T> = DefaultEventMap> {
...
interface EventEmitter<T extends EventMap<T> = DefaultEventMap>
  extends NodeJSEventEmitter<T> {}

interface ReadlineInterface extends EventEmitter {
