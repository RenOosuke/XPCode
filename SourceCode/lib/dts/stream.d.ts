...
declare namespace stream {
    ...
    interface ReadableBase extends Stream {
        /**
         ...
         * @since v16.8.0
         */
        isDisturbed(stream: Readable | NodeJS.ReadableStream): boolean;
        /**
         ...
         * @since v20.4.0
         */
        // [SymbolConstructor.asyncDispose](): Promise<void>;
    }
    import WritableOptions = internal.WritableOptions;
    interface WritableBase extends Stream {
        /**
    ...
    namespace internal {
         ...
         * @since v0.9.4
         */
        interface Readable extends ReadableBase {
            /**
             ...
             * @experimental
             */
            toWeb(streamReadable: Readable): streamWeb.ReadableStream;
        }
         ...
         * @since v0.9.4
         */
        interface Writable extends WritableBase {
            /**
             ...
             * @experimental
             */
            toWeb(streamWritable: Writable): streamWeb.WritableStream;
        }
         ...
         * @since v0.9.4
         */
        interface Duplex extends ReadableBase implements WritableBase {
            readonly writable: boolean;
            readonly writableEnded: boolean;
            readonly writableFinished: boolean;
            readonly writableHighWaterMark: number;
         ...
         */
        interface PassThrough extends Transform {}
        /**
