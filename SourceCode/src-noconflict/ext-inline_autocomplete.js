ace.define("ace/snippets", [], function (require, exports, module) {
  ...
  var SnippetManager = /** @class */ (function () {
    ...
    SnippetManager.prototype.getVariableValue = function (
      editor,
      name,
      indentation
    ) {
    ...
    SnippetManager.prototype.getDisplayTextForSnippet = function (
      editor,
      snippetText
    ) {
    ...
    SnippetManager.prototype.insertSnippetForSelection = function (
      editor,
      snippetText,
      options
    ) {
      ...
      var processedSnippet = processSnippetText.call(
        this,
        editor,
        snippetText,
        options
      ...
      tabstopManager.addTabstops(
        processedSnippet.tabstops,
        range.start,
        end,
        selectionId
      );
    };
    SnippetManager.prototype.insertSnippet = function (
      editor,
      snippetText,
      options
    ) {
    ...
    SnippetManager.prototype.expandSnippetForSelection = function (
      editor,
      options
    ) {
    ...
    SnippetManager.prototype.findMatchingSnippet = function (
      snippetList,
      before,
      after
    ) {
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var AceInlineScreenReader = /** @class */ (function () {
      ...
      AceInlineScreenReader.prototype.setScreenReaderContent = function (
        content
      ) {
        if (
          !this.popup &&
          this.editor.completer &&
          ...
          this.popup.renderer.on(
            ...
            function () {
              ...
              if (selected) {
                ...
                for (
                  var lineIndex = 0;
                  lineIndex < this._lines.length;
                  lineIndex++
                ) {
                  idString += "ace-inline-screenreader-line-".concat(
                    lineIndex,
                    " "
                  );
                }
      ...
      AceInlineScreenReader.prototype.createCodeBlock = function () {
        ...
        for (var lineIndex = 0; lineIndex < this._lines.length; lineIndex++) {
          ...
          codeElement.setAttribute(
            "id",
            "ace-inline-screenreader-line-".concat(lineIndex)
          );
...
ace.define("ace/autocomplete/inline", [], function (require, exports, module) {
  "use strict";
  var snippetManager = require("../snippets").snippetManager;
  var AceInlineScreenReader =
    require("./inline_screenreader").AceInlineScreenReader;
  var AceInline = /** @class */ (function () {
    ...
    AceInline.prototype.show = function (editor, completion, prefix) {
      ...
      var displayText = completion.snippet
        ? snippetManager.getDisplayTextForSnippet(editor, completion.snippet)
        : completion.value;
      if (
        completion.hideInlinePreview ||
        !displayText ||
        !displayText.startsWith(prefix)
      ) {
        return false;
      }
      this.editor = editor;
...
ace.define("ace/autocomplete/popup", [], function (require, exports, module) {
  ...
  var AcePopup = /** @class */ (function () {
    function AcePopup(parentNode) {
      ...
      popup.renderer.$textLayer.element.setAttribute(
      ...
      popup.renderer.$textLayer.element.setAttribute(
        "aria-label",
        nls("autocomplete.popup.aria-label", "Autocomplete suggestions")
      );
      ...
      popup.renderer.on("afterRender", function () {
        ...
        var selected = /** @type {HTMLElement|null} */ (
        ...
        if (selected) {
          ...
          selected.setAttribute(
            "aria-roledescription",
            nls("autocomplete.popup.item.aria-roledescription", "item")
          );
          selected.setAttribute(
            "aria-label",
            popup.getData(row).caption || popup.getData(row).value
          );
      ...
      popup.setRow = function (line) {
        line = Math.max(
          this.autoSelect ? 0 : -1,
          Math.min(this.data.length - 1, line)
        );
      ...
      popup.tryShow = function (pos, lineHeight, anchor, forceShow) {
        if (
          ...
          popup.anchorPos &&
          popup.anchor &&
          popup.anchorPos.top === pos.top &&
          popup.anchorPos.left === pos.left &&
          popup.anchor === anchor
        ) {
          return true;
        }
        ...
        var spaceBelow =
          screenHeight - pos.top - 3 * this.$borderSize - lineHeight;
  ...
  exports.triggerAutocomplete = function (editor, previousChar) {
    ...
    return editor.completers.some(function (completer) {
      if (
        ...
        Array.isArray(completer.triggerCharacters)
      ) {
...
ace.define("ace/autocomplete", [], function (require, exports, module) {
  ...
  var Autocomplete = /** @class */ (function () {
    function Autocomplete() {
      ...
      this.popupTimer = lang.delayedCall(
      ...
      this.$firstOpenTimer = lang.delayedCall(
        /**@this{Autocomplete}*/ function () {
          var initialPosition =
            this.completionProvider && this.completionProvider.initialPosition;
          if (
            this.autoShown ||
          ...
          this.completions = new FilteredList(
            Autocomplete.completionsForLoading
          );
    ...
    Autocomplete.prototype.$seen = function (completion) {
      if (
        !this.hasSeen.has(completion) &&
        completion &&
        completion.completer &&
        completion.completer.onSeen &&
        typeof completion.completer.onSeen === "function"
      ) {
    ...
    Autocomplete.prototype.$onPopupRender = function () {
      ...
      if (
        ...
        this.completions.filtered.length > 0
      ) {
        for (
          var i = this.popup.getFirstVisibleRow();
          i <= this.popup.getLastVisibleRow();
          i++
        ) {
    ...
    Autocomplete.prototype.$updatePopupPosition = function () {
      ...
      var editorContainerBottom =
        editor.container.getBoundingClientRect().bottom - lineHeight;
      var lowestPosition =
        editorContainerBottom < posGhostText.top
    ...
    Autocomplete.prototype.openPopup = function (
      ...
      if (
        newRow === oldRow &&
        previousSelectedItem !== this.completions.filtered[newRow]
      )
        this.$onPopupChange();
      var inlineEnabled = this.inlineRenderer && this.inlineEnabled;
    ...
    Autocomplete.prototype.insertMatch = function (data, options) {
      ...
      var result = this.getCompletionProvider().insertMatch(
        this.editor,
        data,
    ...
    Autocomplete.prototype.updateCompletions = function (
      keepPopupPosition,
      options
    ) {
      ...
      this.getCompletionProvider({
        ...
        function (err, completions, finished) {
          ...
          this.completions =
            !finished && this.showLoadingState
              ? new FilteredList(
                  Autocomplete.completionsForLoading.concat(filtered),
                  completions.filterText
                )
              : completions;
          this.openPopup(this.editor, prefix, keepPopupPosition);
  ...
  var CompletionProvider = /** @class */ (function () {
    ...
    CompletionProvider.prototype.insertByIndex = function (
      editor,
      index,
      options
    ) {
      ...
      return this.insertMatch(
        editor,
        this.completions.filtered[index],
        options
      );
    };
    CompletionProvider.prototype.insertMatch = function (
      editor,
      data,
      options
    ) {
      ...
      if (data.completer && data.completer.insertMatch) {
        ...
        if (data.range && data.range.start.row === data.range.end.row) {
          ...
          replaceBefore +=
            this.initialPosition.pos.column - data.range.start.column;
          replaceAfter +=
            data.range.end.column - this.initialPosition.pos.column;
        }
        ...
        if (
          data.completer &&
          data.completer.onInsert &&
          typeof data.completer.onInsert == "function"
        ) {
    ...
    CompletionProvider.prototype.gatherCompletions = function (
      editor,
      callback
    ) {
    ...
    CompletionProvider.prototype.provideCompletions = function (
      editor,
      options,
      callback
    ) {
  ...
  var FilteredList = /** @class */ (function () {
    ...
    FilteredList.prototype.filterCompletions = function (items, needle) {
      ...
      loop: for (var i = 0, item; (item = items[i]); i++) {
        var caption =
          (!this.ignoreCaption && item.caption) || item.value || item.snippet;
        if (!caption) continue;
        var lastIndex = -1;
        var matchMask = 0;
        var penalty = 0;
...
ace.define("ace/ext/command_bar", [], function (require, exports, module) {
  var __values =
    (this && this.__values) ||
    function (o) {
  ...
  var CommandBarTooltip = /** @class */ (function () {
    function CommandBarTooltip(parentNode, options) {
      ...
      this.maxElementsOnTooltip =
        options.maxElementsOnTooltip || defaultMaxElements;
      this.$alwaysShow = options.alwaysShow || false;
      this.eventListeners = {};
      this.elements = {};
      this.commands = {};
      this.tooltipEl = dom.buildDom(
        ["div", { class: TOOLTIP_CLASS_NAME }],
        this.tooltip.getElement()
      );
      this.moreOptionsEl = dom.buildDom(
        ["div", { class: TOOLTIP_CLASS_NAME + " tooltip_more_options" }],
        this.moreOptions.getElement()
      );
      this.$showTooltipTimer = lang.delayedCall(
        this.$showTooltip.bind(this),
        options.showDelay || defaultDelay
      );
      this.$hideTooltipTimer = lang.delayedCall(
        this.$hideTooltip.bind(this),
        options.hideDelay || defaultDelay
      );
      ...
      try {
        for (
          var _b = __values(["mousedown", "mouseup", "click"]), _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
          var event = _c.value;
          this.tooltip
            .getElement()
            .addEventListener(event, this.$preventMouseEvent);
          this.moreOptions
            .getElement()
            .addEventListener(event, this.$preventMouseEvent);
        }
    ...
    CommandBarTooltip.prototype.updatePosition = function () {
      ...
      var cursorVisible =
        pos.top >= rect.top &&
        pos.top <= rect.bottom &&
        pos.left >= rect.left + renderer.gutterWidth &&
        pos.left <= rect.right;
      ...
      var tooltipFits =
        top >= 0 &&
        top + tooltipEl.offsetHeight <= screenHeight &&
        left >= 0 &&
        left + tooltipEl.offsetWidth <= screenWidth;
      if (!tooltipFits) {
        this.$hideTooltip();
        return;
      }
      ...
      if (this.isMoreOptionsShown()) {
        ...
        left =
          this.elements[MORE_OPTIONS_BUTTON_ID].getBoundingClientRect().left;
    ...
    CommandBarTooltip.prototype.$createCommand = function (
      id,
      command,
      forMainTooltip
    ) {
    ...
    CommandBarTooltip.prototype.$onMouseMove = function (e) {
      ...
      var cursorScreenPosition = this.editor.renderer.textToScreenCoordinates(
        cursorPosition.row,
      ...
      var isInCurrentLine =
        ...
        e.clientY < cursorScreenPosition.pageY + lineHeight;
      if (isInCurrentLine) {
    ...
    CommandBarTooltip.prototype.$updateOnHoverHandlers = function (
      enableHover
    ) {
      var tooltipEl = this.tooltip.getElement();
      var moreOptionsEl = this.moreOptions.getElement();
      if (enableHover) {
        if (this.editor) {
          ...
          this.editor.renderer
            .getMouseEventTarget()
            .addEventListener("mouseout", this.$scheduleTooltipForHide, true);
        }
        ...
        moreOptionsEl.addEventListener(
          "mouseleave",
        ...
        moreOptionsEl.removeEventListener(
          "mouseleave",
          this.$scheduleTooltipForHide
        );
      }
  ...
  dom.importCssString(
    "\n.ace_tooltip."
      ...
      .concat(BUTTON_CLASS_NAME, ".ace_selected,\ndiv.")
      .concat(
        BUTTON_CLASS_NAME,
      ...
      .concat(TOOLTIP_CLASS_NAME, ".tooltip_more_options .")
      .concat(BUTTON_CLASS_NAME, " {\n    display: flex;\n}\n\n.")
      .concat(TOOLTIP_CLASS_NAME, ".")
      .concat(VALUE_CLASS_NAME, " {\n    display: none;\n}\n\n.")
      .concat(TOOLTIP_CLASS_NAME, ".tooltip_more_options .")
      .concat(
        VALUE_CLASS_NAME,
  ...
  function (require, exports, module) {
    ...
    var InlineAutocomplete = /** @class */ (function () {
      ...
      InlineAutocomplete.prototype.getInlineTooltip = function () {
        if (!this.inlineTooltip) {
          this.inlineTooltip = InlineAutocomplete.createInlineTooltip(
      ...
      InlineAutocomplete.prototype.insertMatch = function () {
        var result = this.getCompletionProvider().insertByIndex(
          this.editor,
          this.$index
        );
        this.detach();
      ...
      InlineAutocomplete.prototype.goTo = function (where) {
        ...
        switch (where.toLowerCase()) {
          case "prev":
            this.setIndex(
              (this.$index - 1 + completionLength) % completionLength
            );
            break;
          case "next":
            this.setIndex(
      ...
      InlineAutocomplete.prototype.setIndex = function (value) {
        ...
        var newIndex = Math.max(
          -1,
          Math.min(this.completions.filtered.length - 1, value)
        );
    ...
    InlineAutocomplete.prototype.commands = {
      ...
      Accept: {
        ...
        name: "Accept",
        exec: function (editor) {
          return /**@type{InlineAutocomplete}*/ (
            editor.completer
          ).insertMatch();
        },
      },
        ...
        getValue: function (editor) {
          return editor
            ? [
                ...
                /**@type{InlineAutocomplete}*/ (editor.completer).getLength(),
              ].join("/")
            : "";
        },
        type: "text",
